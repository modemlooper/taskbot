		...
		<li <?php bp_group_class(); ?>>
			...
			<div class="item">
				...
				<div class="item-meta">
					...
					?>
					<span class="desktop"><?php esc_attr_e( sprintf( '%s %s %s', ucfirst( bp_get_group_status() ), apsa_get_group_type( bp_get_group_id() ), apsa_get_group_details_field( 'apsa_group_identifier', bp_get_group_id() ) ), 'boss' ); ?>&nbsp; / </span><?php  echo $html; ?>
