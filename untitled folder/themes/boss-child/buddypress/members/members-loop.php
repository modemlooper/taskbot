		...
		<li>
			...
			<div class="item">
				<div class="item-title">
					...
					<?php do_action( 'bp_directory_after_member_name' ); ?>
				</div>
				...
				<div class="item-meta">
					...
					<span class="count"><?php $followers = bp_follow_total_follow_counts( array( 'user_id' => bp_get_member_user_id() ) );
					echo $followers['followers']; ?></span><span><?php _e( 'Followers','boss' ); ?></span>
					<?php endif; ?>
				</div>
